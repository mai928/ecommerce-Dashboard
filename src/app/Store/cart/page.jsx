                                        ...
                                        <div >
                                            ...
                                            <div className='flex items-center justify-between'>
                                                ...
                                                <div className=' flex justify-center items-center gap-6 '>
                                                    <button className='bg-gray-200 px-4 py-1 rounded-s-lg' onClick={() => decreaseQuantity(item.id)}>-</button>
                                                    {item.quantity}
                                                    {
                                                        console.log(item.quantity)
                                                    }
                                                    <button className='bg-e_secondaryColor px-4 py-1 rounded-e-lg' onClick={() => increaseQuantity(item.id)}>+</button>
                                                </div>
